...
The `tab_spanner_delim()` function can take specially-crafted column names and generate one or more spanner column labels (along with relabeling the column labels).
...
pizzaplace |>
  ...
  dplyr::summarize(revenue = sum(price), sold = dplyr::n(), .groups = "drop") |>
