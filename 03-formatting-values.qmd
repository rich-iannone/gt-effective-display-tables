...
When you have full datetime values, `fmt_datetime()` combines date and time formatting.
...
The datetime column now shows both the date (in "Feb 29, 2000" style) and time (in 24-hour format), providing complete temporal information.
