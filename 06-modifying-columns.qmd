...
This chapter has covered the comprehensive set of `cols_*()` functions that modify table structure at the column level. These functions transform raw data columns into polished, presentation-ready table elements.
...
- column addition: `cols_add()` creates new columns from expressions, enabling calculated fields and derived values.
